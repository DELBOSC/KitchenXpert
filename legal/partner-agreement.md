# KitchenXpert Partner Agreement
...
- **3D Models:** Standard 3D model generation from product specifications
...
- Pricing information in Euros (EUR)
...
## ARTICLE 4: KITCHENXPERT OBLIGATIONS

KitchenXpert agrees to the following obligations:
...
## ARTICLE 5: PRODUCT CATALOG

### 5.1 Submission Process

Partner shall submit Product catalog data through one of the following methods:

- Partner Dashboard manual entry
- Bulk upload via CSV/XML template
- API integration
- Direct feed integration (Enterprise tier)

### 5.2 Required Fields

Each Product submission must include the following mandatory fields:
...
- Availability status
- At least one (1) compliant product image
...
- Enterprise Tier: Negotiated rate (typically five to seven percent)
...
- Display Product information, images, and specifications on the Platform
- Include Products in AI-generated kitchen designs and recommendations
...
- 3D rendering engine and visualization tools
- Analytics methodologies and reporting formats

### 7.4 3D Model Ownership
...
### 8.1 Partner Data Provision

Partner shall provide the following data to KitchenXpert:

- Product specifications and catalog information
- Current pricing and availability
- Inventory levels (for real-time availability display)
- Order fulfillment status and tracking information

### 8.2 KitchenXpert Data Provision

KitchenXpert shall provide Partner with:

- Anonymized and aggregated analytics on Product performance
- Order data for Products purchased through the Platform
- Market insights and trend reports (Pro and Enterprise tiers)
- Competitive positioning data (Enterprise tier, where legally permissible)
...
- Sell personal data obtained through this partnership
- Use data for purposes beyond the scope of this Agreement
- Share data with third parties without appropriate consent or legal basis
- Retain data beyond the period necessary for the specified purposes
...
- Marketing strategies and unreleased product information
...
### 10.1 Partner Warranties

Partner represents and warrants that:

- It has full authority to enter into this Agreement
- All Product information provided is accurate and not misleading
- Products do not infringe any third-party Intellectual Property Rights
- Products comply with all applicable laws and safety standards
- It has obtained all necessary licenses and permits

### 10.2 KitchenXpert Warranties

KitchenXpert represents and warrants that:

- The Platform will perform substantially in accordance with its documentation
- It has the right to grant the licenses contemplated by this Agreement
- It maintains appropriate security measures for data protection
...
The limitations in this Article 11 shall not apply to:
...
- Infringement claims related to Partner's intellectual property
...
- KitchenXpert's breach of data protection obligations
...
- Cooperate fully in the defense at the indemnifying Party's expense
...
- **Basic Tier:** Month-to-month, ongoing
- **Pro Tier:** One (1) year initial term
- **Enterprise Tier:** As specified in the Order Form (minimum one year)
...
- Basic Tier: Immediate effect
- Pro Tier: Thirty (30) days written notice
- Enterprise Tier: Ninety (90) days written notice
...
## EXHIBIT A: PRODUCT DATA REQUIREMENTS
...
- Preferred resolution: 2000 x 2000 pixels
- File formats: JPEG, PNG, WebP
- Maximum file size: 10 MB per image
- Minimum images per product: 1
- Recommended images: 5+ including detail shots
...
- Net sale price = Gross price - VAT - Discounts
- Commission calculated on confirmed, non-refunded orders
- Adjustments made for returns within thirty (30) days

### B.3 Payment Schedule

- Commission statements generated monthly
- Payment within thirty (30) days of statement
- Minimum payout threshold: EUR 50
...
- Advance notice: 72 hours (standard), 7 days (major updates)

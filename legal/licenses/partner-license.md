# KitchenXpert Partner License Agreement

**Effective Date:** Upon execution of Partner Agreement
...
f) Receive and use data provided by KitchenXpert in accordance with Section 3.

### 1.2 License Scope

This license is limited to:

- Integration with and participation in the KitchenXpert Platform
- Business purposes directly related to the Partner Program
- The territory specified in the Partner Agreement (worldwide unless restricted)
- The duration of the Partner Agreement
...
- Set and update pricing information
...
Partner may configure webhooks to receive real-time notifications for:
...
- Code samples and SDKs (where available)
- Integration guides and best practices
- Changelog and version history
- Developer sandbox environment for testing

### 2.5 API Terms of Use

Partner agrees to:

- Use the API only for authorized purposes under this Partner License
- Implement proper authentication and secure credential storage
- Not share API credentials with unauthorized parties
...
Partner may access data through:

- Partner Dashboard reports and visualizations
- Scheduled email reports (configurable)
- API endpoints for programmatic access
- Downloadable exports (CSV, Excel, JSON)

### 3.3 Data Usage Restrictions

Partner SHALL NOT:

- Sell, rent, or commercially distribute data received from KitchenXpert
- Use customer personal data for purposes other than order fulfillment
- Share data with third parties without appropriate consent or legal basis
- Attempt to re-identify anonymized data
- Use data to harm KitchenXpert or its users
- Retain data beyond the period necessary for authorized purposes

Partner SHALL:

- Implement appropriate security measures to protect received data
- Comply with all applicable data protection laws, including GDPR
- Delete or return data upon termination of the Partner Agreement
- Notify KitchenXpert promptly of any data breach affecting received data
...
- Digital advertising (subject to approval)
- Product packaging (with prior approval)

### 4.2 Co-Marketing Materials

Pro and Enterprise Partners may access co-marketing materials including:

- Joint press release templates
...
- Create derivative marks or combine with Partner's logo
- Use KitchenXpert branding in a disparaging manner

### 4.4 Approval Requirements

Prior written approval is required for:

- Use of KitchenXpert logo (beyond standard badge)
- Press releases mentioning the partnership
- Advertising campaigns featuring KitchenXpert
...
## 5. PRODUCT DATA LICENSE

### 5.1 License Grant to KitchenXpert
...
### 5.2 Ownership Retention

Partner retains all intellectual property rights in:

- Original product designs and specifications
...
For 3D models created by KitchenXpert based on Partner's product specifications:

- **Ownership:** Joint ownership unless otherwise agreed
- **Partner Use:** Partner may use models for own marketing with attribution
- **KitchenXpert Use:** May use on Platform and in promotional materials
- **Third-Party Use:** Requires written consent from both parties
- **Custom Models:** Ownership terms negotiable for custom development

### 5.4 License Duration

The license granted to KitchenXpert continues for:

- The duration of the Partner Agreement
- Ninety (90) days following termination for wind-down purposes
- Indefinitely for archived materials and historical references (non-commercial)
...
- Modify or create derivative brand assets

### 6.2 Compliance Requirements

Partner must comply with:

- All applicable laws and regulations
- KitchenXpert's Acceptable Use Policy
...
- Confidentiality obligations (three years)
- Data protection obligations (as required by law)
- Intellectual property ownership
- Limitation of liability
- Indemnification obligations

### 7.4 Effect on Orders

Orders placed before termination will be honored:

- Partner must fulfill pending orders
- KitchenXpert will remit applicable payments
- Customer support obligations continue for fulfilled orders
- Returns and warranties handled per original terms
...
KitchenXpert retains all rights in:
...
- KitchenXpert brand assets and trademarks
- Analytics methodologies and reports

### 8.2 Partner IP

Partner retains all rights in:

- Product designs, specifications, and documentation
- Brand names, trademarks, and trade dress
- Marketing materials and product images
- Customer relationships and order data
...
- It has authority to grant the licenses in this Partner License
- Product information provided is accurate and not misleading
- Partner owns or has rights to all submitted content
...
- The API will perform substantially as documented
- Partner Dashboard will be reasonably available
- Data provided will be reasonably accurate

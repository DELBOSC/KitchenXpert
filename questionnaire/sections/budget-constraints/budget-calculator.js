...
const STANDARD_ALLOCATIONS = {
  cabinets: { min: 0.25, max: 0.35, typical: 0.30 },
  appliances: { min: 0.15, max: 0.25, typical: 0.20 },
  countertops: { min: 0.08, max: 0.15, typical: 0.10 },
  flooring: { min: 0.05, max: 0.10, typical: 0.07 },
  ...
  contingency: { min: 0.10, max: 0.20, typical: 0.15 }
};
...
function generateBudgetWarnings(allocations, params) {
  ...
  if (allocations.contingency.percentage < 0.10) {
    warnings.push({
...
function calculatePotentialSavings(baseAllocation, savingsStrategies) {
  const savingsImpact = {
    'stock-cabinets': { category: 'cabinets', savings: 0.30 },
    'rta-cabinets': { category: 'cabinets', savings: 0.40 },
    'laminate-counters': { category: 'countertops', savings: 0.50 },
    'lvp-flooring': { category: 'flooring', savings: 0.40 },
    'diy-demo': { category: 'installation', savings: 0.10 },
    'diy-paint': { category: 'installation', savings: 0.05 },
    'diy-backsplash': { category: 'backsplash', savings: 0.60 },
    'basic-fixtures': { category: 'plumbing', savings: 0.30 }
  };

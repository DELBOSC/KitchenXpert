...
2. [Data Controller Identity](#2-data-controller-identity)
3. [Definitions](#3-definitions)
4. [Data We Collect from Partners](#4-data-we-collect-from-partners)
5. [Legal Basis for Processing](#5-legal-basis-for-processing)
6. [How We Use Partner Data](#6-how-we-use-partner-data)
...
10. [Partner Rights Under GDPR](#10-partner-rights-under-gdpr)
11. [Data Security Measures](#11-data-security-measures)
12. [Cookies and Tracking in Partner Portal](#12-cookies-and-tracking-in-partner-portal)
...
- The Partner Portal (partners.kitchenxpert.com)
- Partner API integrations
- Partner application and onboarding processes
- Communications between KitchenXpert and Partners
...
## 4. Data We Collect from Partners
...
- Business addresses (headquarters, warehouses, offices)
...
### 4.4 Analytics and Performance Data
...
KitchenXpert does not intentionally collect:

- Sensitive personal data (special categories under GDPR)
- Personal data of Partner employees beyond business contacts
...
- **Legal Compliance:** Maintaining records for legal and tax purposes
...
We process certain data to comply with legal obligations (Article 6(1)(c) GDPR):
...
## 6. How We Use Partner Data

### 6.1 Account Management

We use Partner data to:

- Create and maintain Partner accounts
- Verify Partner identity and credentials
- Manage user access and permissions
- Process account changes and updates
...
- Display products on the KitchenXpert Platform
- Process customer orders and transactions
- Manage inventory and availability
- Generate product recommendations
- Facilitate 3D kitchen design features
- Enable search and discovery of products
...
- Provide market insights and benchmarks
...
Within KitchenXpert, Partner data may be accessed by:

- **Partner Success Team:** For account management and support
- **Technical Team:** For platform operations and integration support
- **Finance Team:** For payment processing and reporting
- **Marketing Team:** For co-marketing and promotional activities
...
The following Partner information is visible to customers on the Platform:
...
We may disclose Partner data when required by law:
...
- In connection with bankruptcy or reorganization proceedings

We will notify Partners of legal requests where permitted by law.
...
- Error logs: 3 months
- Basis: Security, troubleshooting
...
1. Data is identified for deletion
2. Active data is removed from production systems
3. Backup data is removed according to backup rotation schedules
4. Deletion is logged and verified
5. Confirmation provided (for deletion requests)

Some data may be retained in anonymized form for statistical purposes.

---

## 10. Partner Rights Under GDPR

### 10.1 Overview of Rights

Under GDPR, Partners have the following rights regarding their personal data:
...
**Response Time:** Without undue delay, and within 30 days at most.
...
**How to Exercise:** Contact privacy@kitchenxpert.com
...
### 11.3 Certifications and Compliance

KitchenXpert maintains the following certifications and compliance measures:
...
1. **Detection:** Continuous monitoring for incidents
2. **Containment:** Immediate steps to limit impact
3. **Assessment:** Evaluate scope and severity
4. **Notification:** Notify affected parties and authorities as required
5. **Remediation:** Address vulnerabilities and restore services
...
## 12. Cookies and Tracking in Partner Portal
...
**These cookies can be managed in your preferences.**

### 12.2 Cookie Settings

You can manage cookie preferences:

- Through the cookie banner when first accessing the Portal
- In the Partner Portal settings under "Privacy Preferences"
- Through your browser settings

### 12.3 Other Tracking Technologies

We may use additional technologies:

- Local storage for application data
- Session storage for temporary data
- Pixels for email open tracking (can be disabled in email preferences)
...
If you are not satisfied with our response to your inquiry:

1. Contact our DPO at dpo@kitchenxpert.com
2. Escalate to our Legal Team at legal@kitchenxpert.com
3. Lodge a complaint with CNIL or your local supervisory authority
...
- [Data Sharing Agreement](./data-sharing-agreement.md)
- [Intellectual Property Guidelines](./intellectual-property.md)
- Partner Security Whitepaper (available upon request)

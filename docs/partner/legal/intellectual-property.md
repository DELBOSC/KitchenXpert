...
3. [Partner Intellectual Property](#3-partner-intellectual-property)
4. [KitchenXpert Intellectual Property](#4-kitchenxpert-intellectual-property)
5. [License Grants](#5-license-grants)
6. [3D Model Ownership and Usage](#6-3d-model-ownership-and-usage)
7. [Brand Usage Guidelines](#7-brand-usage-guidelines)
8. [Infringement Procedures](#8-infringement-procedures)
9. [Warranties and Representations](#9-warranties-and-representations)
10. [Indemnification](#10-indemnification)
11. [Term and Survival](#11-term-and-survival)
...
a) Clearly define which intellectual property belongs to each party;
...
- Brand names, logos, and trademarks of both parties
- Any derivative works created from the above
...
## 3. Partner Intellectual Property
...
- Original product designs and configurations
...
#### 3.1.2 Brand Names and Trademarks

- Registered and unregistered trademarks
- Brand names and product names
- Logos and design marks
- Trade dress and packaging designs
- Slogans and taglines

#### 3.1.3 Patents and Trade Secrets

- Utility patents on product features or manufacturing
- Design patents on product appearance
- Trade secrets and confidential know-how
- Proprietary manufacturing techniques
- Pending patent applications

#### 3.1.4 Product Images and Marketing Materials

- Product photography and images
- Marketing collateral and brochures
- Advertising copy and content
- Promotional videos and multimedia
- Catalog designs and layouts

#### 3.1.5 3D Models Provided by Partner

- 3D models created by or for Partner
- CAD files and technical drawings
- BIM (Building Information Modeling) data
- AR/VR assets created by Partner
- Any modifications Partner makes to such models
...
a) Maintaining and protecting Partner's Intellectual Property Rights;
...
e) Updating or removing Content that may infringe third-party rights.

---

## 4. KitchenXpert Intellectual Property
...
#### 4.1.2 AI and Machine Learning Models
...
- Training data and methodologies (excluding Partner Content)

#### 4.1.3 KitchenXpert Brand and Trademarks

- "KitchenXpert" name and variations
- KitchenXpert logos (primary, secondary, icon)
- Partner Program badges and certifications
- Marketing slogans and taglines
- Domain names containing "KitchenXpert"

#### 4.1.4 User Interface and Experience
...
#### 4.1.5 Documentation and Marketing Materials

- Help documentation and guides
- API documentation
- Marketing materials created by KitchenXpert
- Press releases and announcements
- Blog content and articles
- Email templates and communications

#### 4.1.6 3D Models Created by KitchenXpert

- 3D models of Partner products created by KitchenXpert
- Design room templates and scenes
...
### 5.1 License from Partner to KitchenXpert
...
a) Commences upon Partner uploading Content to the Platform;
...
- Credit in marketing materials (where feasible)

### 5.2 License from KitchenXpert to Partner
...
This license is subject to the Brand Usage Guidelines in Section 7.
...
## 6. 3D Model Ownership and Usage

### 6.1 Categories of 3D Models

Three categories of 3D models exist within the Platform:

#### 6.1.1 Partner-Provided Models

Models created by or for Partner and uploaded to the Platform.
...
#### 6.1.2 KitchenXpert-Created Models

Models created by KitchenXpert based on Partner product information.
...
- May not resell or redistribute commercially
...
#### 6.2.1 Partner-Provided Model Requirements

Partner-provided 3D models must:

a) Be in approved formats (OBJ, FBX, GLTF, STEP, or as specified);

b) Meet minimum quality standards (polygon count, texture resolution);

c) Accurately represent the actual product;

d) Not contain any malicious code or hidden elements;

e) Include appropriate metadata (dimensions, materials, colors);

f) Be owned by Partner or properly licensed for use.

#### 6.2.2 KitchenXpert Model Standards

KitchenXpert-created models:

a) Will accurately represent products based on provided information;

b) Will be optimized for web and mobile viewing;
...
To request updates to KitchenXpert-created models:

a) Submit request through Partner Portal or to Partner Success Manager;

b) Provide updated specifications, images, or information;

c) Updates will be processed according to Partner Tier timeframes;

d) Major redesigns may require new model creation.
...
### 7.1 Approved Uses of KitchenXpert Marks

Partners may use KitchenXpert Brand Elements in the following approved ways:
...
- "Shop our products on KitchenXpert"
...
Badge files are available in the Partner Portal under Brand Assets.
...
- KitchenXpert design tools (with approved deep links)
...
#### 7.2.1 False or Misleading Uses

- Imply exclusivity unless contractually agreed
- Suggest endorsement beyond the partnership scope
- Claim KitchenXpert recommends Partner over competitors
- Misrepresent the nature or extent of the partnership

#### 7.2.2 Brand Modifications

- Modify KitchenXpert logos or marks
- Change colors, proportions, or elements
- Add effects, shadows, or outlines
- Combine with other logos to create new marks

#### 7.2.3 Unauthorized Placements

- Use KitchenXpert Marks in domain names (without approval)
- Use in social media handles or profile names
- Use as keywords for paid advertising (without approval)
- Use in ways that suggest KitchenXpert origin

#### 7.2.4 Disparaging Uses

- Use in any manner that disparages KitchenXpert
- Use in connection with illegal or unethical activities
- Use in ways that could damage KitchenXpert reputation
- Use in adult, violent, or otherwise inappropriate contexts

### 7.3 KitchenXpert Use of Partner Marks

KitchenXpert may use Partner Brand Elements to:

a) Display products on the Platform (product listings, search results);

b) Include in marketing materials (partner directories, case studies);

c) Reference in press releases and announcements;

d) Display in the Partner showcase and directories;
...
- Remove or update Partner Marks upon reasonable request

### 7.4 Approval Process for Marketing Materials
...
- Factual statements about the partnership
...
- Trade show materials featuring KitchenXpert prominently
- Case studies or testimonials about KitchenXpert

#### 7.4.3 How to Request Approval
...
### 7.5 Brand Asset Downloads

Official brand assets are available in the Partner Portal:

- KitchenXpert logos (various formats, colors, sizes)
- Partner badges (by tier level)
- Co-marketing templates
- Brand guidelines document
- Approved imagery for marketing use

---

## 8. Infringement Procedures

### 8.1 Reporting Infringement to KitchenXpert

#### 8.1.1 Types of Infringement

Partners should report:

- Use of Partner Content without authorization
- Counterfeit or infringing products on the Platform
- Unauthorized use of Partner trademarks
- Copyright infringement involving Partner materials
- Patent infringement related to Partner products

#### 8.1.2 How to Report

Submit infringement reports to: legal@kitchenxpert.com

Or use the Infringement Report form in the Partner Portal.

#### 8.1.3 Information Required
...
c) Contact information of the reporting party;

d) Statement of good faith belief that the use is not authorized;
...
### 8.2 KitchenXpert Investigation and Response
...
#### 8.2.2 Investigation Timeline

- Initial review: Within 5 business days
- Investigation completion: Within 15 business days
- Complex cases: May require additional time (with notification)

#### 8.2.3 Potential Actions

Based on investigation findings, KitchenXpert may:

a) Remove allegedly infringing content pending resolution;

b) Contact the allegedly infringing party for response;

c) Restore content if the claim is unfounded;

d) Permanently remove infringing content;

e) Suspend or terminate accounts of repeat infringers;

f) Provide information to law enforcement if requested.
...
#### 8.3.2 Counter-Notification Requirements
...
d) Contact information and signature.

#### 8.3.3 Counter-Notification Process
...
### 8.4 Partner Obligations

Partners shall:

a) Promptly report any suspected infringement of their rights;

b) Respond to any claims that Partner Content infringes third-party rights;

c) Cooperate with KitchenXpert in investigating infringement claims;
...
#### 9.1.1 Ownership and Rights

a) Partner owns or has validly licensed all Partner Content;
...
#### 9.1.3 Content Accuracy

a) Partner Content accurately represents Partner's products;
...
c) Allow the indemnifying party to control defense and settlement.
...
The following provisions survive termination of the Partner Agreement:

- Section 3 (Partner Intellectual Property) - ownership provisions
- Section 4 (KitchenXpert Intellectual Property) - ownership provisions
- Section 9 (Warranties and Representations)
- Section 10 (Indemnification) - for claims arising during the term
...
### 12.1 Intellectual Property Inquiries
...
### 12.3 Brand Asset Requests

For brand assets, co-marketing requests, or marketing approvals:

**Email:** marketing@kitchenxpert.com

**Partner Portal:** Brand Assets section

### 12.4 3D Model Requests

For questions about 3D models or model updates:

**Email:** 3d-models@kitchenxpert.com

**Partner Portal:** Products > 3D Models section

### 12.5 Partner Support
...
- Brand Guidelines (available in Partner Portal)
- 3D Model Specifications (available in Partner Portal)

---

## Appendix A: Quick Reference - Approved vs. Prohibited Uses
...
## Appendix B: Partner Badge Specifications

### Badge Versions Available

1. **Standard Partner Badge**
   - For Basic tier Partners
   - Available in color, white, and black versions
   - Minimum size: 100px width

2. **Pro Partner Badge**
   - For Pro tier Partners
   - Includes "Pro" designation
   - Available in color, white, and black versions
   - Minimum size: 120px width

3. **Enterprise Partner Badge**
   - For Enterprise tier Partners
   - Premium design with "Enterprise" designation
...
- Color badge: Use on white or light backgrounds
- White badge: Use on dark or colored backgrounds
- Black badge: Use on white or light backgrounds only

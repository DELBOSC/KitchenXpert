# Product Metadata and SEO Guidelines
...
**Best Practices**: Include brand, model, category, 1-2 key features. Keep under
200 chars.
...
**Example**: "This modern base cabinet features soft-close doors and durable MDF
construction with matt white lacquer finish. At 60cm wide, perfect for standard
layouts. Adjustable interior shelf allows flexible storage. Compatible with all
standard worktops."
...
Auto-translation provided; professional translations recommended for top
products.

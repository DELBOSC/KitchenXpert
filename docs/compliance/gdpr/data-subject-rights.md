...
2. [Right to Access (Article 15)](#right-to-access-article-15)
3. [Right to Rectification (Article 16)](#right-to-rectification-article-16)
4. [Right to Erasure (Article 17)](#right-to-erasure-article-17)
5. [Right to Restriction (Article 18)](#right-to-restriction-article-18)
6. [Right to Data Portability (Article 20)](#right-to-data-portability-article-20)
7. [Right to Object (Article 21)](#right-to-object-article-21)
8. [Automated Decision-Making (Article 22)](#automated-decision-making-article-22)
9. [Request Process and Verification](#request-process-and-verification)
10. [Response Timelines](#response-timelines)
11. [Request Templates](#request-templates)
...
**Self-Service**: Account Settings > Privacy > Download My Data (24-48 hours)

**Formal Request**: Email rights@kitchenxpert.com (30 days response)

### Export Formats

JSON (technical), CSV (spreadsheet), PDF (human readable)
...
- Consent withdrawn
- Objection with no overriding legitimate grounds
- Unlawful processing
- Legal obligation
...
Account Settings > Privacy > Delete Account (30-day grace period)
...
**Allowed**: Storage, processing with consent, legal claims, public interest

**Not Allowed**: Regular processing, analytics, marketing, third-party sharing
...
Derived data (recommendations), data about others, legitimate interest data

### How to Exercise

Account Settings > Privacy > Export My Data > Portable format (48 hours)

---

## Right to Object (Article 21)

### Marketing Objection (Absolute)

Must stop immediately, no balancing test, all channels

**Methods**: Unsubscribe link, Preference Center, Direct request

### Profiling Objection

Account Settings > Privacy > Personalization > Disable recommendations/analytics
...
Request via rights@kitchenxpert.com, response within 14 days

---

## Request Process and Verification
...
- [DPIA](./dpia.md)
- [CCPA Consumer Rights](../ccpa/consumer-rights.md)

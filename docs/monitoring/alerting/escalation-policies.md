...
> Comprehensive guide to alert escalation procedures and policies for
> KitchenXpert.
...
KitchenXpert uses a four-level escalation hierarchy to ensure incidents are
addressed by the appropriate personnel.
...
```yaml
# Create silence
amtool silence add alertname="HighErrorRate" \ --comment="Planned deployment" \
--author="ops@kitchenxpert.com" \ --duration="2h"
```
...
_For questions about escalation policies, contact the SRE team at

...
- [Purpose](#purpose-of-the-questionnaire)
- [How It Works](#how-it-works)
- [Question Categories](#question-categories)
- [Completing the Questionnaire](#completing-the-questionnaire)
- [Understanding Your Results](#understanding-your-results)
- [Modifying Answers](#modifying-questionnaire-answers)
...
- Budget-optimized smart allocation
...
[Screenshot: AI questionnaire welcome screen]
...
1. **Answer Questions** (3-5 minutes): 15-20 questions about your needs
2. **AI Processing** (5-15 seconds): Analyzes answers, applies design principles
3. **Review Results**: View primary design + alternatives with scores
4. **Customize** (Optional): Accept as-is or modify freely
...
[Screenshot: Dimension input interface]
...
- Ventilation: Wall/island range hood
...
[Screenshot: Budget input with allocation pie chart]
...
[Screenshot: Submission and processing screen]
...
- Below 55: Review alternatives or regenerate

[Screenshot: Primary design with score breakdown]
...
- Save multiple for later comparison
...
[Screenshot: Design rationale panel]

---

## Modifying Questionnaire Answers
...
1. Initial questionnaire → Design A
2. Like layout, not style → Adjust style → Design B
3. Like B, need more storage → Adjust storage → Design C
4. Perfect! → Save Design C

All generations saved in "My AI Designs" for comparison.
...
**After reviewing AI-generated design:**

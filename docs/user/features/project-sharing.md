...
- [Overview](#overview)
- [Share Types and Permissions](#share-types-and-permissions)
- [Sharing with Family and Friends](#sharing-with-family-and-friends)
- [Professional Collaboration](#professional-collaboration)
- [Real-Time Co-Editing](#real-time-co-editing)
- [Version Control and History](#version-control-and-history)
- [Comments and Feedback](#comments-and-feedback)
- [Contractor Handoff Package](#contractor-handoff-package)
- [Public Portfolio Sharing](#public-portfolio-sharing)
...
- Repeat multiple times (slow, frustrating)
...
- Complete version history (track evolution)
- Seamless handoff to manufacturing and installation
...
- Transparent process (all stakeholders aligned)

[Screenshot: Project sharing dashboard showing active collaborators]
...
- Create snapshots (save versions)
...
- **Best for:** Portfolio showcase, social media sharing
...
- Can set expiration (7 days, 30 days, never)
...
- Showcases your design publicly
- **Best for:** Portfolio websites, social media

[Screenshot: Share settings dialog with permission options]
...
**Scenario:** You want opinions from family on your kitchen design.

**Step-by-Step:**

1. **Prepare Project**
   - Finalize design (or reach decision point)
   - Clean up (hide experimental elements)
...
2. **Generate Share Link**
   ...
   - Choose method:
     - **Email:** Enter email addresses (mom@email.com, sister@email.com)
     - **Link:** Generate shareable link

3. **Set Permission**
   - **Commenter** (recommended for feedback)
   - Viewers can see design, add comments
   - Cannot change your design

4. **Customize Message**
   - Add personal note: "What do you think of the island size?"
   - KitchenXpert sends invitation email
   - Or copy link to text/message

5. **Review Feedback**
   - Collaborators open link (any device)
   - Explore 3D design
   - Add comments (pin to specific locations)
   - You receive notifications

[Screenshot: Email invitation preview]

---

### Collaborative Decision-Making (Spouse/Partner)

**Scenario:** You and your partner are designing together.
...
1. **Invite as Editor**
   ...
   - Permission: **Editor**
   - Both have full editing rights

2. **Real-Time Collaboration**
   - Both can be in project simultaneously
   - See each other's cursor/avatar
   - Voice chat (optional, via built-in or external app)
   - Changes sync instantly

3. **Divide and Conquer**
   - You: Work on cabinet layout
   - Partner: Select appliances
   - Both: Review together in VR

4. **Resolve Disagreements**
   - Create alternative versions (branching)
   - Branch A: Your preference
   - Branch B: Partner's preference
   - Compare side-by-side
   - Merge best elements

---

### Gathering Opinions (Extended Family, Friends)

**Scenario:** You want broad feedback without overwhelming everyone.

**Best Practices:**

1. **Create Decision Points**
   - Don't share work-in-progress constantly
   - Share at major milestones:
     - Layout finalized
     - Materials selected
     - Final design before ordering

2. **Focused Questions**
   - Instead of "What do you think?", ask:
     - "Island too big or just right?"
     - "White or gray cabinets?"
     - "Is the backsplash too busy?"

3. **Use Annotations**
   - Add pins highlighting decision points
   - "Vote: Island size—comment if too big, too small, or just right"
...
5. **Thank Participants**
   - Acknowledge feedback (even if not implementing)
   - Close loop: "We went with the white cabinets—thanks for voting!"
...
**Scenario:** You've hired a professional designer.
...
- File sharing (inspiration images, spec sheets)

[Screenshot: Designer collaboration interface with chat]

---

### Collaborating with Contractors

**Scenario:** You need installation quotes from contractors.
...
1. **Create Quote Package**
   ...
   - Excludes: Pricing (if you don't want to disclose)

2. **Share with Multiple Contractors**
   - Share > Add Collaborators
   - Enter 3-5 contractor emails
   - Permission: **Viewer**
   - Each gets private link (can't see each other)
...
4. **Questions and Clarifications**
   - Contractors add comments (if Commenter permission)
   - "Is there blocking in this wall for cabinet mounting?"
   - You respond via comments
...
2. **Installation Coordination**
   - Contractor accesses project on-site (mobile app)
   - References 3D model during install
   - Marks completion (progress tracking)

---

### Manufacturer Integration

**Scenario:** Ordering custom cabinets from local manufacturer.

**Direct Integration:**

1. **Share with Manufacturer**
   - Find manufacturer in KitchenXpert network
   - Or add custom manufacturer
   - Share project (Viewer or Editor)

2. **Manufacturer Generates Quote**
   - Accesses 3D model
   - Exports CAD/CAM files (if Editor permission)
   - Prepares itemized quote
   - Quote visible in shared project

3. **Refinements**
   - Manufacturer suggests modifications (comments)
   - "This cabinet dimension non-standard—suggest 80cm instead of 78cm"
   - You approve or discuss
   - Changes made collaboratively

4. **Order Placement**
   - Final design locked (version snapshot)
   - Manufacturer begins fabrication
   - Progress updates in project timeline

See [Local Manufacturing](local-manufacturing.md) for full details.
...
- Presence awareness ("Sarah is viewing the island")
...
[Screenshot: Multiple users' cursors visible in 3D designer]
...
- Automatic snapshots:
  ...
  - Before sharing with new collaborator
  - Before exporting contractor package
...
[Screenshot: Version timeline with thumbnails]
...
1. **Save Current State**
   - File > Save Version
   - Name: "Option A - White Cabinets"
   - Description: "Modern white shaker cabinets with quartz countertops"
   - Tags: "modern", "white", "quartz"

2. **View Version History**
   - File > Version History
   - List of all versions (newest first)
   - Details: Name, date, author, description

3. **Restore Previous Version**
   - Select version from history
   - Click "Restore"
   - Current version saved automatically (not lost)
...
3. **Toggle Differences**
   - Show only changed elements
   - Or show full design with changes highlighted

4. **Merge Elements**
   - Take island from Version A
   - Take cabinets from Version B
...
[Screenshot: Branch visualization diagram]
...
1. **Select Element**
   - Click cabinet, countertop, appliance, etc.
...
3. **Type Comment**
   - Text entry field appears
   - "This cabinet should be 10cm wider"
   - Attach image (optional, e.g., inspiration photo)

4. **Submit**
   - Comment pin appears in 3D space
...
[Screenshot: Comment thread on kitchen island]
...
4. Designer locks version as "Final"
...
1. **3D Model (Interactive)**
   - Full design
   - Viewer link (no edit rights)
   - Accessible on-site (mobile/tablet)

2. **2D Drawings**
   - Floor plan (top view with dimensions)
   - Elevations (front, side views of each wall)
   - Detail drawings (complex areas: corners, islands)
   - Electrical plan (outlet and lighting locations)
   - Plumbing plan (sink, dishwasher, fridge water line)

3. **Cut Lists and Specifications**
   - Component list (every cabinet, countertop, etc.)
   - Dimensions (W × D × H)
   - Materials and finishes
   - Hardware specifications

4. **Installation Instructions**
   - Sequence (what to install first, second, etc.)
   - Mounting heights
   - Leveling requirements
   - Special considerations

5. **Product Information**
   - Appliance specs (dimensions, power requirements)
   - Cabinet manufacturer details
   - Countertop material specs
   - Hardware model numbers

[Screenshot: Sample contractor package PDF]
...
1. **Finalize Design**
   ...
   - Run validation check (Tools > Validate for Installation)
   - Fix any errors or warnings

2. **Export Package**
   - File > Export > Contractor Handoff Package
   - Choose export options:
     - ☑ 3D Model (interactive viewer link)
     - ☑ 2D Drawings (PDF, DWG, or both)
     - ☑ Cut Lists (Excel, CSV)
     - ☑ Installation Guide (PDF)
     - ☑ Product Specs (PDF)

3. **Customize**
   - Add notes: "Wall behind sink requires waterproofing"
   - Highlight critical areas
   - Add contractor contact info (for questions)

4. **Generate**
   - Click "Generate Package"
   - Processing time: 1-3 minutes (depending on complexity)
   - Download ZIP file or share link

5. **Share with Contractor**
   - Upload to project sharing (Viewer permission)
   - Or email ZIP file
   - Or provide shareable link (no account required)
...
1. **Enable Public Sharing**
   - Project > Share Settings > Public Portfolio
   - Toggle "Make Public"

2. **Customize Public View**
   - Title and description (for SEO)
   - Cover image (hero screenshot)
   - Hide sensitive info (pricing, personal details)

3. **Choose What's Visible**
   - ☑ 3D model (interactive viewer)
   - ☑ Images (rendered views)
   - ☑ Design story (text description)
   - ☐ Pricing (optional)
   - ☐ Product links (optional)

4. **Generate Public Link**
   - Unique URL: kitchenxpert.com/p/your-username/modern-farmhouse-kitchen
   - Shareable on social media
   - Embeddable on websites

[Screenshot: Public portfolio example]
...
**Add 3D viewer to your website:**

1. **Generate Embed Code**
   - Public Project > Share > Embed
   - Customize viewer size (width, height)
   - Choose features (allow fullscreen, show UI)
...
4. **Visitor Experience**
   ...
   - No KitchenXpert account required
...
- Social media (embed in Facebook, LinkedIn posts)
...
- IP restrictions (Enterprise tier—limit to specific locations)
...
- Change password
- Extend/shorten expiration

[Screenshot: Collaborator management panel]
...
- Notifications (new comments, design changes)
...
4. See new design overlaid in real space
...
4. Takes photos of discrepancies
...
4. Approve or request revision (one tap)
...
- Keep master copy with restricted access
...
- Share publicly without owner's permission
...
- Consider all feedback thoughtfully
...
- Leave feedback unresolved (creates uncertainty)
...
4. Link not revoked accidentally (Share > Manage Collaborators)
...
- Contact support if persistent (rare)

---

### Too Many Cooks

**"Too many editors making conflicting changes":**

**Solutions:**

1. **Reduce Editors**
   - Downgrade some to Commenters
   - Designate primary editor

2. **Divide Work**
   - Assign zones: "You handle left wall, I'll do island"
   - Time slots: "I'll work 9am-12pm, you work 1pm-4pm"

3. **Use Branches**
   - Each editor works in separate branch
   - Merge branches later
   - Avoids conflicts

4. **Lock Elements**
   - Right-click element > Lock
   - Prevents accidental changes by others
   - Unlock when needed
...
**"Too many comments, can't track them all":**

**Solutions:**

1. **Filter Comments**
   - Show only "Open" (hide resolved)
   - Filter by priority (critical, normal, low)
   - Filter by author (see only client comments)

2. **Batch Resolve**
   - Address all comments on one element
   - Mark all as resolved together
   - Add summary note: "All island comments addressed"

3. **Create To-Do List**
   - Export comments to task list
   - Prioritize outside of KitchenXpert
   - Work through systematically

4. **Set Comment Guidelines**
   - Request one comment per issue (not multiple)

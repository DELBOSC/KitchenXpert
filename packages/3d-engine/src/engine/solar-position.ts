...
export const CITY_LOCATIONS: Record<string, GeoLocation> = {
  ...
  // ── North America ──
  newYork: { latitude: 40.7128, longitude: -74.006, timezone: -5 },
  ...
  bogota: { latitude: 4.711, longitude: -74.0721, timezone: -5 },
...
export class SolarCalculator {
  ...
  static calculateSunPosition(
    ...
    const intensity = altitude > 0 ? Math.min(1, Math.max(0, altitude / 60)) : 0;

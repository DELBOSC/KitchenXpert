...
const StylePreferences: React.FC = () => {
  ...
  const styleOptions = useMemo(
    () => [
      {
        id: 'modern',
        name: t('style.options.modern', 'Modern'),
        image: '/images/styles/modern.jpg',
        description: t('style.options.modern.desc', 'Clean lines, minimal ornamentation'),
      },
      {
        id: 'traditional',
        name: t('style.options.traditional', 'Traditional'),
        image: '/images/styles/traditional.jpg',
        description: t('style.options.traditional.desc', 'Classic details, warm tones'),
      },
      {
        id: 'contemporary',
        name: t('style.options.contemporary', 'Contemporary'),
        image: '/images/styles/contemporary.jpg',
        description: t('style.options.contemporary.desc', 'Current trends, bold accents'),
      },
      {
        id: 'transitional',
        name: t('style.options.transitional', 'Transitional'),
        image: '/images/styles/transitional.jpg',
        description: t('style.options.transitional.desc', 'Blend of traditional and modern'),
      },
      {
        id: 'farmhouse',
        name: t('style.options.farmhouse', 'Farmhouse'),
        image: '/images/styles/farmhouse.jpg',
        description: t('style.options.farmhouse.desc', 'Rustic, cozy, natural materials'),
      },
      {
        id: 'industrial',
        name: t('style.options.industrial', 'Industrial'),
        image: '/images/styles/industrial.jpg',
        description: t('style.options.industrial.desc', 'Raw materials, urban aesthetic'),
      },
      {
        id: 'scandinavian',
        name: t('style.options.scandinavian', 'Scandinavian'),
        image: '/images/styles/scandinavian.jpg',
        description: t('style.options.scandinavian.desc', 'Light, airy, functional'),
      },
      {
        id: 'mediterranean',
        name: t('style.options.mediterranean', 'Mediterranean'),
        image: '/images/styles/mediterranean.jpg',
        description: t('style.options.mediterranean.desc', 'Warm colors, ornate details'),
      },
    ],
    [t]
  );
  ...
  const colorSchemes = useMemo(
    () => [
      {
        id: 'neutral',
        name: t('style.colors.neutral', 'Neutral'),
        colors: ['#F5F5F5', '#E0E0E0', '#9E9E9E', '#616161'],
      },
      {
        id: 'warm',
        name: t('style.colors.warm', 'Warm'),
        colors: ['#FFF8E1', '#FFE0B2', '#FFCC80', '#FF9800'],
      },
      {
        id: 'cool',
        name: t('style.colors.cool', 'Cool'),
        colors: ['#E3F2FD', '#BBDEFB', '#90CAF9', '#2196F3'],
      },
      {
        id: 'monochrome',
        name: t('style.colors.monochrome', 'Monochrome'),
        colors: ['#FFFFFF', '#BDBDBD', '#757575', '#212121'],
      },
      {
        id: 'earth',
        name: t('style.colors.earth', 'Earth Tones'),
        colors: ['#EFEBE9', '#D7CCC8', '#A1887F', '#5D4037'],
      },
      {
        id: 'bold',
        name: t('style.colors.bold', 'Bold'),
        colors: ['#FCE4EC', '#F48FB1', '#E91E63', '#4A148C'],
      },
    ],
    [t]
  );
  ...
  useEffect(() => {
    ...
    const fetchStyleData = async (): Promise<void> => {
      try {
        ...
        logger.debug(
          'Failed to fetch style preferences, using defaults',
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    if (!formData.primaryStyle) {
      setSaveError(
        t('questionnaire.style.selectStyleRequired', 'Veuillez selectionner un style principal')
      );
      return;
    }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
              {t('questionnaire.step', { current: 3, total: 4, defaultValue: 'Step 3 of 4' })}
            </span>
            <span className="text-sm text-gray-500 dark:text-gray-400">
              {t('questionnaire.stylePreferences', 'Style Preferences')}
            </span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            {t(
              'questionnaire.stylePreferencesDesc',
              'Choose your design aesthetic and material preferences for your dream kitchen.'
            )}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">
                {t('questionnaire.style.primaryStyle', 'Style de design principal')}{' '}
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">
                {t('questionnaire.style.colorScheme', 'Palette de couleurs')}
              </h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">
                {t('questionnaire.style.materials', 'Materiaux et finitions')}
              </h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">
                {t('questionnaire.style.hardwareLighting', 'Quincaillerie et eclairage')}
              </h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">
                {t('questionnaire.style.additionalNotes', 'Notes supplementaires')}
              </h2>
              <textarea
                ...
                rows={4}
                placeholder={t(
                  'questionnaire.style.notesPlaceholder',
                  'Exigences de design, inspirations ou indispensables pour votre cuisine...'
                )}
            ...
            {aiTips && (
              <div className="mt-6 space-y-3">
                {aiTips.tips.map((tip, i) => (
                  <div
                    key={i}
                    className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm text-blue-800 dark:text-blue-300"
                  >
                    <span className="font-medium">
                      {t('questionnaire.style.aiTip', 'Conseil IA')} :
                    </span>{' '}
                    {tip}
                  </div>
                ))}
                {aiTips.warnings.map((w, i) => (
                  ...
                  >
                    <span className="font-medium">
                      {t('questionnaire.style.aiWarning', 'Attention')} :
                    </span>{' '}
                    {w}
                  </div>
                ))}
                {aiTips.suggestions.map((s, i) => (
                  <div
                    key={i}
                    className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-sm text-gray-700 dark:text-gray-300"
                  >
                    <span className="font-medium">
                      {t('questionnaire.style.aiSuggestion', 'Suggestion')} :
                    </span>{' '}
                    {s}
                  </div>
                ))}

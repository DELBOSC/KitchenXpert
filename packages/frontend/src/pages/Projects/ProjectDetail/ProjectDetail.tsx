        ...
        <div className="animate-pulse" role="status" aria-label={t('common.loading', 'Loading')}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="animate-pulse bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4"
              >
              ...
              <div className="flex items-center gap-8">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    {t('projects.spent', {
                      total: formatCurrency(project.budget.total, project.budget.currency),
                    })}
                  </p>
                </div>
                  ...
                  <div className="h-2 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden">
                    <div
                      ...
                      aria-valuenow={Math.round(
                        Math.min((project.budget.spent / project.budget.total) * 100, 100)
                      )}
                      aria-valuemin={0}
                      aria-valuemax={100}
          ...
          {project.kitchens.length === 0 ? (
            <div className="text-center py-12 border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">
                {t('projects.noKitchens')}
              </h3>
              <p className="mt-2 text-gray-500 dark:text-gray-400">
                {t('projects.noKitchensDesc')}
              </p>
              <button
                onClick={() => navigate(`/projects/${projectId}/kitchens/create`)}
              ...
              {project.kitchens.map((kitchen) => (
                ...
                >
                  <div className="h-40 bg-gray-100 dark:bg-gray-700 relative">
                    ...
                    <span
                      className={`absolute top-2 right-2 px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(kitchen.status)}`}
                    >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">
                      {t('project.dimensions', '{{width}}m x {{depth}}m x {{height}}m', {
                        width: kitchen.dimensions.width,
                        depth: kitchen.dimensions.depth,
                        height: kitchen.dimensions.height,
                      })}
                    </p>
                  </div>
                </Link>

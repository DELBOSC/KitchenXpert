...
function FeatureSection({
  ...
  return (
    <section id={id} aria-labelledby={`${id}-title`} className="border-t border-white/5 py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div
          className={`grid items-center gap-12 lg:grid-cols-2 ${imageRight ? '' : 'lg:[direction:rtl]'}`}
        >
  ...
  <div className="flex aspect-[16/10] items-center justify-center">
    <div className="text-center">
      ...
      <div className="mt-1 text-[10px] text-white/25">
        Capture à fournir — voir docs/HERO-VIDEO.md
      </div>
    </div>
  </div>
);
...
const FEATURES: Array<Omit<FeatureSectionProps, 'index' | 'imageRight'>> = [
  {
    ...
    utmTag: 'snap',
    paragraph1:
      "Les caissons s'alignent automatiquement aux murs et entre eux : pas de millimètre perdu, pas d'écart de 3 mm gênant à l'œil. Les guides bleus apparaissent dès qu'un alignement est détecté, et disparaissent une fois l'objet posé.",
    paragraph2:
      'Le snap fonctionne sur les axes X/Y/Z, sur les centres et sur les arêtes. Vous pouvez le désactiver temporairement en maintenant ⌥ (Mac) ou Alt (PC).',
  ...
  },
  {
    ...
    paragraph1:
      'Concevez une fois, comparez chez IKEA, Schmidt, Mobalpa, Leroy Merlin et Bosch. Le moteur réajuste les dimensions standard de chaque marque (60 cm chez IKEA, 63 cm chez certains Schmidt) sans casser votre layout.',
    paragraph2:
      "Le devis se recalcule en parallèle dans le panneau de droite — vous voyez l'écart de prix avant même d'avoir cliqué.",
  ...
  },
  {
    ...
    utmTag: 'pathtracer',
    paragraph1:
      "Cliquez « Rendu HD » et le path-tracer accumule l'éclairage en temps réel. En 4 secondes, vous obtenez un rendu de niveau magazine : reflets sur l'inox, ombres douces sous les meubles hauts, profondeur de champ sur le plan de travail.",
    paragraph2:
      'Le moteur tourne sur GPU côté navigateur (WebGPU/WebGL2). Sur compte payant, vous accédez à 4K + 64 samples par pixel.',
  ...
  },
  {
    ...
    utmTag: 'ar_vr',
    paragraph1:
      'Sur smartphone (iOS 16+ / Android 12+), un bouton AR superpose votre projet à la vraie pièce via la caméra. Vous validez les volumes en condition réelle, sans calculer mentalement.',
    paragraph2:
      "Pour les casques (Quest 3, Vision Pro), le mode VR vous fait marcher dans la cuisine à l'échelle 1:1. Démontre l'effet « waouh » en showroom.",
  ...
  },
  {
    ...
    utmTag: 'plan_2d',
    paragraph1:
      "Le bouton « Vue 2D » bascule en plan technique annoté avec toutes les cotes, prêt à imprimer pour l'artisan. Le bouton « Élévation » donne la vue de face de chaque mur, avec hauteurs et cotes ouvertures.",
    paragraph2:
      'Export DXF/PDF inclus. Compatible avec AutoCAD et SketchUp pour les artisans qui retravaillent vos plans.',
  ...
  },
  {
    ...
    utmTag: 'walkthrough',
    paragraph1:
      "Un mode « première personne » avec contrôles WASD + souris vous fait marcher dans la cuisine. Idéal pour valider l'ergonomie : est-ce qu'on peut ouvrir le four sans buter dans l'îlot ?",
    paragraph2:
      'Enregistrez la vidéo du parcours en un clic — parfait pour partager le projet avec votre conjoint, votre architecte ou un cuisiniste à distance.',
  ...
  },
  {
    ...
    utmTag: 'catalog',
    paragraph1:
      "Plus de 6 000 références IKEA METOD synchronisées toutes les 24 heures avec le catalogue officiel : prix, disponibilité, dimensions et photos. Les références supprimées d'IKEA disparaissent du designer.",
    paragraph2:
      'Filtrez par couleur, hauteur, type de façade — la recherche reste fluide même avec 60 caissons dans la scène.',
  ...
  },
  {
    ...
    utmTag: 'devis',
    paragraph1:
      "Chaque meuble ajouté met à jour instantanément le devis dans le panneau droit. Trois lignes : prix HT, TVA, TTC. Une ligne pour la pose si vous l'incluez. Trois colonnes : IKEA, Leroy Merlin, Schmidt — pour voir l'écart en direct.",
  ...
  },
  {
    ...
    utmTag: 'installers',
    paragraph1:
      "Une fois le projet validé, vous pouvez le pousser à un réseau d'installateurs certifiés KitchenXpert (artisans agréés Qualibat / RGE). Devis pose sous 48 h, comparaison côte à côte.",
    paragraph2:
      "Les installateurs voient votre projet en lecture seule (modèle 3D + plan 2D + BOM) — ils n'ont pas accès à votre catalogue ni à vos données personnelles.",
  ...
  },
  {
    ...
    utmTag: 'bim',
    paragraph1:
      'Exportez votre projet au format IFC 4.3 — le standard ouvert du BIM. Compatible avec Revit, ArchiCAD, Vectorworks et tous les logiciels du marché.',
    paragraph2:
      "Réservé au plan Studio. Idéal pour les architectes d'intérieur qui intègrent KitchenXpert dans une chaîne de production existante.",
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <header className="mx-auto max-w-6xl px-6 pt-24 pb-12 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-white/60">
          30 secondes pour comprendre. 10 fonctionnalités pour décider. Aucun compte requis.
        </p>
      </header>
      ...
      {FEATURES.map((feature, i) => (
        <FeatureSection key={feature.id} {...feature} index={i + 1} imageRight={i % 2 === 0} />
      ))}
      ...
      <section className="border-t border-white/5 py-20 text-center">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <p className="mt-4 text-white/60">
            Sans compte, sans CB. Votre projet reste en local jusqu&apos;à ce que vous décidiez de
            l&apos;enregistrer.
          </p>
          <Link

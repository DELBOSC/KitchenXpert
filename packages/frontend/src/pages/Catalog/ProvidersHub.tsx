    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <Container size="xl" className="py-10">
        ...
        {providers && (
          ...
          >
            {providers.map((p) => {
              const blurb = PROVIDER_BLURBS[p.code] ?? {
                tagline: '',
                segment: '',
                accent: 'from-white/10 via-white/5',
              };
              return (
                <motion.div
                  key={p.code}
                ...
                >
                  ...
                  >
                    <div
                      className={`absolute -top-16 -right-16 h-40 w-40 rounded-full bg-gradient-to-br ${blurb.accent} to-transparent blur-2xl transition group-hover:scale-110`}
                      aria-hidden
                    />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-white/60">
                Le catalogue IKEA est interrogé en direct via l&apos;API officielle. Les dimensions
                sont extraites en temps réel.
              </p>
            </div>
          </div>
        </Card>

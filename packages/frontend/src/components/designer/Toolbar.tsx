...
function Divider(): React.ReactElement {
  return (
    <div
      className="w-px h-8 bg-gray-200 dark:bg-gray-600 mx-1"
      role="separator"
...
export default function Toolbar({
  ...
  return (
    <div
      role="toolbar"
      aria-label={t('designer.toolbar.ariaLabel', 'Designer tools')}
      className="flex items-center gap-1 px-3 py-2 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm"
    >
      {/* Transform tools */}
      ...
      >
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M4 4h4v4H4zM16 4h4v4h-4zM4 16h4v4H4zM16 16h4v4h-4zM10 10h4v4h-4z"
          />
        </svg>
      </ToolButton>
      ...
      >
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M21 6H3M21 6v2M3 6v2M21 18H3M21 18v-2M3 18v-2"
          />
      ...
      >
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M3 21l18-18M9 3v4M3 9h4M15 21v-4M21 15h-4"
          />
        </svg>
      </ToolButton>
          ...
          const icons: Record<LightingPresetName, React.ReactNode> = {
            ...
            natural: (
              <svg
                ...
                strokeWidth={2}
              >
                <path d="M3 15h18M12 3a9 9 0 019 9" />
                <circle cx="12" cy="12" r="5" />
              </svg>
            ),
          };

...
export default function AIAssistantPanel({
  ...
  const runAnalysis = useCallback(() => {
    if (!engine || !aiAssistantRef.current) {
      return;
    }
  ...
  const runAutoComplete = useCallback(() => {
    if (!engine || !aiAssistantRef.current || !smartPlacementRef.current) {
      return;
    }
            ...
            <div className="flex-1 min-w-0">
              ...
              {suggestions.length === 0 ? (
                <p className="text-xs text-gray-400 dark:text-gray-500">
                  {t(
                    'designer.ai.noSuggestions',
                    'Aucune suggestion. Votre configuration est optimale !'
                  )}
                </p>
              ) : (
          ...
          {pmrMode && pmrScore && (
            <div className="px-4 pb-3 border-t border-gray-100 dark:border-gray-700 pt-3">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span
                  className={`ml-auto px-2 py-0.5 text-[10px] font-bold rounded ${
                    pmrScore.compliant
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span
                            className={`px-1 py-0.5 text-[9px] font-bold rounded uppercase ${
                              violation.severity === 'critical'

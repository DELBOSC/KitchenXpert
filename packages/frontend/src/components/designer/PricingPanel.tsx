...
function groupByCategory(items: PriceItem[], t: (key: string, defaultValue: string) => string): CategoryTotal[] {
    ...
    <div className="bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 w-64 flex flex-col">
      ...
      <div className="px-4 py-4 border-b border-gray-100 dark:border-gray-700">
        <div className="text-center">
          <span className={`text-2xl font-bold ${isOverBudget ? 'text-red-500' : 'text-gray-800 dark:text-gray-200'}`}>
          ...
          <div className="mt-3">
            ...
            {isOverBudget && (
              <p className="text-xs text-red-500 mt-1">
                {t('designer.pricing.overBudget', 'Depassement')}: +{(total - budget!).toLocaleString('fr-FR')} €
              </p>
            )}
          </div>
        )}

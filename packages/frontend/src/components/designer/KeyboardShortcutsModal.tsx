...
export default function KeyboardShortcutsModal({ isOpen, onClose }: KeyboardShortcutsModalProps): React.ReactElement | null {
  ...
  const shortcutCategories: ShortcutCategory[] = useMemo(() => [
    ...
    },
    {
      ...
      shortcuts: [
        { action: t('shortcuts.toggleSnapping', 'Activer/Desactiver l\'aimantation'), keys: ['G'] },
      ],
    },
    {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
        <div role="dialog" aria-modal="true" className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-lg max-h-[80vh] overflow-hidden pointer-events-auto">
          {/* Header */}

...
export const CATALOG_COLOR_PALETTE: Record<ColorKey, CatalogColorEntry> = {
  ...
  champagne: { label: 'Champagne', hex: '#E6D2A8', roughness: 0.28, metalness: 0.35, type: 'metal' },
  graphite: { label: 'Graphite', hex: '#2B2B2E', roughness: 0.28, metalness: 0.15, type: 'laminate' },
  bordeaux: { label: 'Bordeaux', hex: '#5C2A33', roughness: 0.25, metalness: 0.05, type: 'laminate' },

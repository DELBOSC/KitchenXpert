...
const variants = {
  ...
  elevated:
    'border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] shadow-[0_8px_32px_rgba(0,0,0,0.3)]',
  interactive:
    'border border-white/10 bg-white/[0.03] transition hover:border-white/20 hover:bg-white/[0.05] cursor-pointer',
...
export function CardTitle({
  ...
  return (
    <h3 className={cn('text-base font-semibold tracking-tight text-white', className)} {...rest}>
      {children}
    </h3>
  );
}

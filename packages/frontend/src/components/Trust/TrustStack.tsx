...
const ITEMS: StackItem[] = [
  {
    ...
    detail:
      'IKEA METOD, Schmidt, Bosch, Leroy Merlin Delinia, Castorama — sync quotidienne des prix.',
  },
  {
    icon: <IconRuler />,
  ...
  },
  {
    ...
    detail:
      'Export Art. 15 + Effacement Art. 17 disponibles côté utilisateur sans intervention support.',
  },
  {
    icon: <IconCookie />,
    label: '0 cookie tiers sans consentement',
    detail:
      'Plausible Analytics (cookieless, CNIL-exempt) chargé uniquement après consentement explicite. Aucun tracker publicitaire.',
  },
  {
    icon: <IconSparkle />,
    label: 'Path-tracing photoréaliste maison',
    detail:
      'Moteur de rendu propriétaire, exécuté côté navigateur (WebGPU). Pas de cloud rendering — vos données restent locales.',
  },
  {
    icon: <IconHandshake />,
  ...
  },
  {
    ...
    detail:
      'support@kitchenxpert.com — équipe à Toulouse, réponse ouvrée sous 24 h, escalade équipe technique sous 48 h.',
  },
];
...
export function TrustStack({
  ...
  return (
    <section aria-label="Garanties et engagements" className={`${className}`}>
      <ul className={isGrid ? 'grid gap-4 sm:grid-cols-2 lg:grid-cols-4' : 'flex flex-col gap-3'}>
        {ITEMS.map((item) => (
          <li
            key={item.label}
            className={
...
function IconRuler(): React.ReactElement {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M3 13l10 -10 4 4l-10 10zM6 10l2 2M9 7l2 2M12 4l2 2" strokeLinecap="round" />
    </svg>
  );
}
function IconShield(): React.ReactElement {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M10 2l7 3v5c0 4-3 7-7 8c-4-1-7-4-7-8V5l7-3z" strokeLinejoin="round" />
      <path d="M7 10l2 2l4-4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function IconCookie(): React.ReactElement {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M10 17a7 7 0 1 1 7-7c0 0.5 -1 1 -2 0.5s-2-0.5-2 0.5s-1 2 -2 1s-2 -1 -2 1s-1 2 -3 1" />
...
function IconSparkle(): React.ReactElement {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M10 3l1.5 4.5L16 9l-4.5 1.5L10 15l-1.5-4.5L4 9l4.5-1.5z" strokeLinejoin="round" />
    </svg>
  );
}
function IconHandshake(): React.ReactElement {
  return (
    ...
    >
      <path
        d="M2 10l3-3l5 5l-3 3a2 2 0 1 1 -3 -3l3 -3M18 10l-3-3l-5 5l3 3a2 2 0 1 0 3 -3l-3 -3"
        strokeLinecap="round"
...
function IconHeadset(): React.ReactElement {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M3 12V9a7 7 0 0 1 14 0v3" />
      <rect x="2" y="12" width="3" height="5" rx="1" />
      <rect x="15" y="12" width="3" height="5" rx="1" />
    </svg>
  );
}

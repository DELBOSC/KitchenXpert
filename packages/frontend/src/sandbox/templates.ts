...
export const SANDBOX_TEMPLATES: SandboxTemplate[] = [
  {
    ...
    layout: 'L_SHAPED',
    widthCm: 280, depthCm: 280, heightCm: 250,
    coverUrl: '/templates/l-small.jpg',
    items: [
      item('METOD-60-WHITE', 'Caisson bas 60 — blanc',  { x: 0,   y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 169),
      item('METOD-80-WHITE', 'Caisson bas 80 — blanc',  { x: 60,  y: 0,   z: 0 }, { w: 80,  d: 60, h: 80 }, 199),
      item('METOD-EVIER-60', 'Caisson évier 60',        { x: 140, y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 219),
      item('METOD-PLAQUE-60','Caisson plaque 60',       { x: 200, y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 209),
      // Retour (mur perpendiculaire)
      item('METOD-COIN',     'Caisson d\'angle',         { x: 200, y: 60,  z: 0 }, { w: 80,  d: 80, h: 80 }, 289, 90),
      item('METOD-60-WHITE', 'Caisson bas 60 — blanc',  { x: 200, y: 140, z: 0 }, { w: 60,  d: 60, h: 80 }, 169, 90),
    ],
  },

  {
    ...
    layout: 'U_SHAPED',
    widthCm: 360, depthCm: 320, heightCm: 250,
    coverUrl: '/templates/u-medium.jpg',
    items: [
      // Mur principal
      item('METOD-EVIER-80', 'Caisson évier 80',        { x: 0,   y: 0,   z: 0 }, { w: 80,  d: 60, h: 80 }, 249),
      item('METOD-LAVE-VAIS','Lave-vaisselle 60 intégré',{ x: 80,  y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 449),
      item('METOD-100-WHITE','Caisson bas 100',         { x: 140, y: 0,   z: 0 }, { w: 100, d: 60, h: 80 }, 239),
      item('METOD-PLAQUE-80','Caisson plaque 80',       { x: 240, y: 0,   z: 0 }, { w: 80,  d: 60, h: 80 }, 229),
      // Retour droit
      item('METOD-COIN',     'Coin droit',              { x: 320, y: 0,   z: 0 }, { w: 80,  d: 80, h: 80 }, 289),
      item('METOD-60-WHITE', 'Caisson bas 60',          { x: 320, y: 80,  z: 0 }, { w: 60,  d: 60, h: 80 }, 169, 90),
      // Retour gauche
      item('METOD-FOUR',     'Caisson four 60',         { x: 0,   y: 80,  z: 0 }, { w: 60,  d: 60, h: 80 }, 359, 90),
      item('METOD-FRIGO',    'Colonne frigo 60',        { x: 0,   y: 140, z: 0 }, { w: 60,  d: 60, h: 220 }, 489, 90),
    ],
  },

  {
    ...
    layout: 'GALLEY',
    widthCm: 320, depthCm: 220, heightCm: 250,
    coverUrl: '/templates/galley.jpg',
    items: [
      // Mur arrière
      item('METOD-EVIER-80', 'Caisson évier 80',        { x: 0,   y: 0,   z: 0 }, { w: 80,  d: 60, h: 80 }, 249),
      item('METOD-LAVE-VAIS','Lave-vaisselle 60',       { x: 80,  y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 449),
...

  {
    ...
    layout: 'ISLAND',
    widthCm: 480, depthCm: 380, heightCm: 270,
    coverUrl: '/templates/island.jpg',
    items: [
      // Mur arrière
      item('METOD-FRIGO-AMER','Frigo américain 90',     { x: 0,   y: 0,   z: 0 }, { w: 90,  d: 65, h: 220 }, 1290),
      item('METOD-FOUR-V',   'Colonne four + micro-ondes',{ x: 90,  y: 0,   z: 0 }, { w: 60,  d: 60, h: 220 }, 689),
      item('METOD-100-BLACK','Bas 100 noir mat',        { x: 150, y: 0,   z: 0 }, { w: 100, d: 60, h: 80 }, 269),
      item('METOD-PLAQUE-80','Plaque induction 80',     { x: 250, y: 0,   z: 0 }, { w: 80,  d: 60, h: 80 }, 229),
      ...
      item('METOD-ILOT-EVIER','Îlot évier + rangement', { x: 120, y: 200, z: 0 }, { w: 240, d: 100, h: 90 }, 1450),
    ],
  },

  {
    ...
    layout: 'OPEN_PLAN',
    widthCm: 420, depthCm: 320, heightCm: 270,
    coverUrl: '/templates/open.jpg',
    items: [
      item('METOD-EVIER-80', 'Évier 80',                { x: 0,   y: 0,   z: 0 }, { w: 80,  d: 60, h: 80 }, 249),
      item('METOD-LAVE-VAIS','Lave-vaisselle',          { x: 80,  y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 449),
...

  {
    ...
    layout: 'ONE_WALL',
    widthCm: 380, depthCm: 200, heightCm: 220,
    coverUrl: '/templates/atypical.jpg',
    items: [
      item('METOD-FRIGO-BAS','Frigo top 60 (sous-plan)',{ x: 0,   y: 0,   z: 0 }, { w: 60,  d: 60, h: 80 }, 449),
      item('METOD-LAVE-VAIS','Lave-vaisselle 45',       { x: 60,  y: 0,   z: 0 }, { w: 45,  d: 60, h: 80 }, 419),
      ...
      item('METOD-FOUR-COMP','Four compact 60',         { x: 305, y: 0,   z: 0 }, { w: 60,  d: 60, h: 60 }, 379),

 ...
 * Cuisinella Scraper
 *
 * Scraper for Cuisinella kitchens (Schmidt Groupe)
 * Part of Schmidt Groupe - similar structure to Schmidt
 *
 * Website: https://www.cuisinella.com
 * Catalog: /fr-fr/cuisines
 */
...
// CSS Selectors for Cuisinella website (similar to Schmidt)
const SELECTORS = {
  // Navigation & Collections
  collectionsMenu: '.nav-cuisines, .menu-cuisines, [data-nav="cuisines"]',
  collectionLinks: '.collection-card a, .cuisine-model a, .model-link, .kitchen-card a',
  collectionTitle: '.collection-title, .model-name, h1.title, .hero-title',
  collectionDescription: '.collection-description, .model-description, .description, .intro-text',
  collectionImage: '.collection-hero img, .model-image img, .hero-image, .banner-image img',

  // Product listing
  productGrid: '.products-grid, .cabinets-list, .product-listing, .elements-grid',
  productCard: '.product-card, .cabinet-card, .item-card, .element-card',
  productLink: '.product-card a, .cabinet-card a, .item-link, .element-link',
  productName: '.product-name, .cabinet-name, .item-title, .element-title',
  productPrice: '.product-price, .price, .prix',
  productImage: '.product-image img, .thumbnail img, .element-image img',

  // Product detail page
  productDetailName: 'h1.product-title, h1.cabinet-name, .detail-title, h1.element-name',
  productDetailRef: '.product-reference, .reference, .sku, .code-article',
  productDetailDescription: '.product-description, .description-text, .detail-description',
  productDetailDimensions: '.dimensions, .product-dimensions, .specs-dimensions, .mesures',
  productDetailPrice: '.detail-price, .product-price-detail',
  productDetailImages: '.product-gallery img, .detail-images img, .gallery-item img',
  productDetailSpecs: '.specifications, .product-specs, .technical-specs, .caracteristiques',

  // Facade/Finish selectors
  facadeSection: '.finishes, .facades, .door-styles, .finitions',
  facadeCard: '.finish-card, .facade-card, .door-style, .finition-item',
  facadeName: '.finish-name, .facade-name, .finition-name',
  facadeColor: '.color-swatch, .color-option, .coloris',

  // Worktop selectors
  worktopSection: '.worktops, .plans-de-travail, .plans-travail',
  worktopCard: '.worktop-card, .plan-card, .plan-travail-item',
...
// Product type mappings (French keywords)
...
export default CuisinellaScraper;

...
- `main` (HEAD `27f14b0`, post-#95 fix LocaleAwareShell deep-link — #79/#91/#92/#93/#94/#95 mergés)
...
- `docs/claude-md-p1-resolved` (branche courante, ce doc)
...
Prochaine cible : (a) **couche 7f — débogage LOCAL** (login 401→dashboard, a11y `color-contrast` réelle, selectors `getByLabel(/nom/)` trop larges, dialog ×2 ; Playwright contre stack up) ; (b) **infra prod §14.2** — prérequis secrets §14.1 ; (c) **Lot 2 Dependabot**. §11 P1 deep-link LocaleAwareShell **RÉSOLU** (#95) ; e2e sur main = rouge informatif ; CodeQL (#2) reporté repo public.

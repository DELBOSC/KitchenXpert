...
- `main` (HEAD `b1d0220`, post-#112 — ROOT CAUSE Provider redux #109 + kitchen-fields #110 + span-click #106 + 12 slices enregistrés #112)
...
- `docs/audit-providers-slices` (branche courante, ce doc)

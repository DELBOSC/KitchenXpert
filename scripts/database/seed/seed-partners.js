...
const partners = [
  // Major kitchen brands
  {
    ...
    status: 'active',
    brand: 'Schmidt',
    description: "Cuisiniste premium proposant des cuisines sur mesure avec un accompagnement personnalisé.",
  ...
  },
  {
    ...
    status: 'active',
    brand: 'Mobalpa',
    description: "Spécialiste de l'aménagement intérieur : cuisines, salles de bains et rangements.",
  ...
  },
  {
    ...
    status: 'active',
    brand: 'IKEA',
    description: "Solutions de cuisines accessibles et personnalisables avec service de planification gratuit.",
